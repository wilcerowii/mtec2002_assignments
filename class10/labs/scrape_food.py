...
scrape_food.py
=====
Open a web page that has a list of restaurants.  Print out the list of all of the restaurants on that page. 
Use the either of the following urls - zagat or yelp...
...
req = resquests.get(url)
print req.text
soup = bs4.beautifulsoup.(req.text)
print soup.find_all('a','restaurants')
for r in rests:
		print r.string