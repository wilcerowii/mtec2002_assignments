...
velocity.py
=====
Write a program that asks for distance and time.  It will print out the velocity.
It should be able to recover from invalid input or division by 0 errors.

1. Loop forever
2. Ask for distance; store in a variable named d
3. Ask for time; store in a variable named t
4. Calculate velocity by converting both values to floats and dividing d/t and print
out the result
