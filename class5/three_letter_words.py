...
Three Letter Words
=====
* Create a list of strings called words that contains "dog","lizard","cat","hawk",
"pig", and "ibek" 
* Create an empty list called three_letter_words
* Use a for loop to iterate through your words list...
* If the length of your word is greater than 3, append it to your
three_letter_words list
