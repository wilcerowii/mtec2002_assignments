...
person = {"frist_name" : "joe", "last_name": "v", "eye_color" : "brown" , " number_of_teeth": 400, "favorite_food" : "chocolate ice cream"}
...
print "%s has %s teeth" % (person['frist_name'],person['number_of_teeth'])
# change your favorite food
person['favorite_food'] = 'kholerabi'
