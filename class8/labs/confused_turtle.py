...
4. For each iteration of the loop
	a. create a variable called my_x and set it to a random
	integer between -150 and 150 using random.randint(-150, 150)
	b. create a variable called my_y and set it to a random 
	integer between -150 and 150 using random.randint(-150, 150)
